    ...
    <div class="vfooter">
        <div>
            <span class="small-font">
                更新时间: 2024-02-29 | 工具数量: <nya-link to="/">{{ this.toolNum }}</nya-link>
            </span>
        </div>
        <div>
            <span class="small-font">
                    © 2024 <a target="_blank" href="https://github.com/showntop">译译译</a> 版权所有 |
                <a href="xx" target="_blank">st</a>
            </span>
        </div>
        <div>
